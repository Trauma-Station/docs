# Trauma Station Admin Policy

```admonish
This applies only to TraumaStation Server(s).
```

## 1. General Adminning
General admin-guidelines. These apply to all ranks of admins: Headmin, Game Admin and Trial Game Admin.
...
This *does* pertain to any information posted in the game admin Discord chats, forum categories, information discussed in admin chat in-game, secret admin notes, as well as PII (IP, HWID) accessible through the central ban DB. This does *not* pertain to basic ban info (time, reason, count), public admin notes, or admin log information.
...
Events should **NOT** be ran without atleast one game admin who is uninvolved with the event online, specifically to prevent breakage of 2.1.
...
```admonish
This section is subject to change as our community and staff grows.
What is currently here are expectations to be upheld until revisions are complete.
```
